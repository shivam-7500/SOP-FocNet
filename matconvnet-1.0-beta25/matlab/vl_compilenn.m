...
switch arch
  ...
  case {'win64'}
    ...
    cl_path = 'C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.29.30037\bin\Hostx64\x86\cl.exe'%fileparts(check_clpath()); % check whether cl.exe in path
